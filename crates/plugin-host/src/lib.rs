...
#[cfg(target_os = "windows")]
pub use dispatch::{
    dispatch_nppm, notify_all, HostServices, Notification, ALL_OPEN_FILES, LINENUMWIDTH_CONSTANT,
    LINENUMWIDTH_DYNAMIC, MAC_FORMAT, MODELESSDIALOGADD, MODELESSDIALOGREMOVE, NPPMAINMENU, NPPMSG,
    NPPMSG_RANGE, NPPPLUGINMENU, PRIMARY_VIEW, RUNCOMMAND_RANGE, RUNCOMMAND_USER, SECOND_VIEW,
    UNIX_FORMAT, UNI_7BIT, UNI_8BIT, UNI_COOKIE, UNI_END, UNI_UTF16BE, UNI_UTF16BE_NO_BOM,
    UNI_UTF16LE, UNI_UTF16LE_NO_BOM, UNI_UTF8, WIN_FORMAT,
};
